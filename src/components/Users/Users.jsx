...
const Users = (props) => {
    ...
    let userElements = props.users.map(
        u => <User name={u.name} followed={u.followed} description={u.status}
                   photo={u.photos.small} country={u.country} city={u.city}
                   id={u.id} follow={props.follow} unfollow={props.unfollow} key={u.id}
